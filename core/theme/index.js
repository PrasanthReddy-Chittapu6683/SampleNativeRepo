...
// console.log("themes file index tenentCtx....", tenentCtx);
  ...
  components: {
    ...
    Heading: {
      baseStyle: {
        ...
        color:
          themeFlag === "apollo"
            ? apolloColors.headings.base.dark
            : colors.headings.base.dark,
        letterSpacing: "3px",
        textTransform: "uppercase",
        _light: {
          color:
            themeFlag === "apollo"
              ? apolloColors.headings.base.light
              : colors.headings.base.light,
        },
      },
      defaultProps: {
